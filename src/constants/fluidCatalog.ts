...
export const FLUID_CATALOG: FluidEntry[] = [
  ...
  { id: 'R448A',   name: 'R448A (Solstice N40)', gwp100: 1274, criticalTempC: 82.68,  criticalPressureBar: 45.95,   ashraeClass: 'A1'  },
  { id: 'R449A',   name: 'R449A (HFO)',       gwp100: 2376, criticalTempC: 75.9,   criticalPressureBar: 39.51,   ashraeClass: 'A1'  },
  { id: 'R452A',   name: 'R452A (HFO)',       gwp100: 2140, criticalTempC: 70.4,   criticalPressureBar: 36.4,    ashraeClass: 'A1'  },
  { id: 'R452B',   name: 'R452B (HFO)',       gwp100: 698,  criticalTempC: 53.2,   criticalPressureBar: 31.13,   ashraeClass: 'A2L' },
  { id: 'R454A',   name: 'R454A (HFO)',       gwp100: 238,  criticalTempC: 70.3,   criticalPressureBar: 36.6,    ashraeClass: 'A2L' },
  { id: 'R454B',   name: 'R454B (HFO)',       gwp100: 466,  criticalTempC: 56.9,   criticalPressureBar: 33.44,   ashraeClass: 'A2L' },
  { id: 'R454C',   name: 'R454C (HFO)',       gwp100: 148,  criticalTempC: 75.8,   criticalPressureBar: 35.29,   ashraeClass: 'A2L' },
  { id: 'R455A',   name: 'R455A (Solstice L40X)', gwp100: 145, criticalTempC: 85.6,  criticalPressureBar: 46.6,   ashraeClass: 'A2L' },
